...
setwd("/rd1/user/lit/project/sORFs/analysis/20250402_mouse_ms_run")
input_path <- "/rd1/user/lit/project/sORFs/analysis/20250402_mouse_ms_run/output/stat"
res_path <- "/rd1/user/lit/project/sORFs/analysis/20250402_mouse_ms_run/output/db_search_20250402"
output_path_1 <- "/rd1/user/lit/project/sORFs/analysis/20250402_mouse_ms_run/output/stat"
output_path_2 <- "/rd1/user/lit/project/sORFs/analysis/20250402_mouse_ms_run/output/plot"
##### 1. Statistics #####
# 统计下总的二级谱图的数量
readRDS(i("sample_metadata_ordered.rds")) -> sample_metadata
## ? 一共是?万的总谱图数量
...
fwrite_c(sample_ms_stat_add_id_rate,i("sample_ms_stat_add_id_rate.txt"))
...
ggsave(cumu_res_1[[2]],filename=o("cumu_sample_n.pdf"),height = 5,width = 10)
ggsave(cumu_res_1[[3]],filename=o("cumu_sample_name.pdf"),height = 5,width = 10)
cumu_sep_peptide_plot(all_sample_sep_unique_psm_1,sample_order) -> cumu_res_2
ggsave(cumu_res_2[[2]],filename=o("cumu_pep_sample_n.pdf"),height = 5,width = 10)
ggsave(cumu_res_2[[3]],filename=o("cumu_pep_sample_name.pdf"),height = 5,width = 10)
