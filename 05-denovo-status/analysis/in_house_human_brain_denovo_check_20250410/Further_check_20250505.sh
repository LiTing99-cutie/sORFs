mkdir -p output/blastp_check && cd output/blastp_check

# 首先对外类群进行blastp
total_pep_fa=/home/user/data3/lit/project/sORFs/03-Cross-anna/analysis/annotate_ms_orfs_20250401/output/prot.fa
gene_lst=/home/user/data3/lit/project/sORFs/03-Cross-anna/analysis/annotate_ms_orfs_20250401/output/sep_to_be_checked.txt
...
# 其次对人这个物种进行blastn
total_cds_fa=/home/user/data3/lit/project/sORFs/03-Cross-anna/analysis/annotate_ms_orfs_20250401/output/cds.fa
