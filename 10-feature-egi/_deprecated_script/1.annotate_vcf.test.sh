...
out_dir=../processed/evolution_para/
...
cp $gtf $snpEff_dir/data/$myGenome/genes.gtf
...
time java -Xmx8g -jar $snpEff_dir/snpEff.jar build -c $snpEff_dir/snpEff.config.$myGenome -gtf22 -v $myGenome && echo "done"
