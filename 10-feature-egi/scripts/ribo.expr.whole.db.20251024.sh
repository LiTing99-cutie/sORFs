...
BAM_1=/home/user/data3/lit/project/sORFs/01-ribo-seq/analysis/20251022_custom_fa_gtf/processed/merged_bam/merged.bam
BAM_2=/home/user/data3/lit/project/sORFs/01-ribo-seq/analysis/20251022_custom_fa_gtf/processed/merged_bam/p_sites_bam/all.offsetCorrected.merged.sorted.bam
OUT=../processed/ribo
mkdir -p "$OUT"
