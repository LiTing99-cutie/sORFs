id_file="../processed/seve_list_compare/non_cano_orfs.sample.2.5k.lt.150aa.id.txt"
denovo_dir=/home/user/data3/lit/project/sORFs/05-denovo-status/analysis/20251029_denovo_check/processed
target_dir="../processed/seve_list_compare/input_for_ortholog_extraction/ortholog_noncano_sample"
