...
lib_text()
filtered_sorfs <- "./mouse_brain_output_20241011/filter/nonCano.sorf.filtered.txt"
sorfs_all_m_s <- "./mouse_brain_output_20241011/filter/nonCano.sorf.meta.merge.raw.3_ways.all_samples.topTrans.txt"
...
fread("./mouse_brain_output_20241011/filter/nonCano.sorf.filtered.txt") -> all_orfs
...
fwrite(all_orfs,file = "./mouse_brain_output_20241011/filter/nonCano.sorf.filtered.add_meta.txt",sep = '\t')