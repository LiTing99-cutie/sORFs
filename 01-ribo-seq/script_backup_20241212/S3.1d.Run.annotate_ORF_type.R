...
lib_text()
sorf_path <- "./mouse_brain_output_20241011/filter/nonCano.sorf.filtered.add_meta.txt"
gpe_path <- "/home/user/data3/lit/resource/gtf/mouse/mm39/gencode.vM29.annotation.gpe.full.txt"
...
# 4.导出
fwrite(sORF,file = "./mouse_brain_output_20241011/filter/nonCano.sorf.filtered.add_meta.orf_type_annotated.txt",sep = '\t')
