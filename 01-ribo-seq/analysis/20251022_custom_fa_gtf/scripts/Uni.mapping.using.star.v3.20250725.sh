...
output_path=$2
mkdir -p $output_path
sample=$(basename "$clean_fq" | sed -E 's/.trimmed.rRNA.tRNA.snoRNA.unaligned.fq.gz//')
### 参考基因组注释文件，根据物种替换 ###
#### 修改 ####
star_rRNA_index=/home/user/data3/lit/project/sORFs/01-ribo-seq/analysis/20250722_formal_data_run/tmp/blastn/total_rRNA_STARindex
