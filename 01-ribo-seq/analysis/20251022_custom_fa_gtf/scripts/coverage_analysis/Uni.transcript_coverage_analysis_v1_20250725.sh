...
# 运行分析脚本
python3 coverage_analysis/transcript_coverage_analysis_v1_20250725.py \
    --input "$INPUT_FILE" \
    --output "$OUTPUT_DIR" \
...
Rscript coverage_analysis/plot_transcript_coverage_simple_v1_20250725.R $OUTPUT_DIR/transcript_coverage_results.csv \
