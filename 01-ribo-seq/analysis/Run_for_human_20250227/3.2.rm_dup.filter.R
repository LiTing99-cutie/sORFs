...
if(is.na(args[1])){
  all_orfs_path <- "/home/user/data3/lit/project/sORFs/01-ribo-seq/analysis/Run_for_human_20250227/human_brain_ribo_merge_call_orfs_20250338/merge/nonCano.sorf.meta.merge.raw.3_ways.txt"
  output_path <- "/home/user/data3/lit/project/sORFs/01-ribo-seq/analysis/Run_for_human_20250227/human_brain_ribo_merge_call_orfs_20250338/merge/"    
}
# uniprot序列
...
matches <- str_match(all_orfs$ORF_id_trans, "([A-Z]+\\d+\\.\\d+)([+-])(chr\\w+):(\\d+)-(\\d+)")
...
# readRDS("/home/user/data3/lit/project/sORFs/01-ribo-seq/analysis/Run_for_human_20250227/human_trans_database_20250324/output/all_orfs_top_trans.rds") -> all_orfs_top_trans
# # 有一些没对应可能是因为PRICE预测的极小一部分ORF里面含有终止密码子
# all_orfs_top_trans %>% .[,c("ORF_id_seq","ORF_id_trans")] -> all_orfs_ORF_id_seq_trans_map
# saveRDS(all_orfs_ORF_id_seq_trans_map,"/home/user/data3/lit/project/sORFs/01-ribo-seq/analysis/Run_for_human_20250227/human_trans_database_20250324/output/all_orfs_ORF_id_seq_trans_map.rds")
