...
if [[ $overlapped == "yes" ]];then
    featureCounts -O -s 1 -t CDS -g transcript_id -a $gtf -o $output_path/rna_counts_1.txt $bam_lst_1
    featureCounts -O -t CDS -g transcript_id -a $gtf -o $output_path/rna_counts_2.txt $bam_lst_2
    featureCounts -O -s 2 -t CDS -g transcript_id -a $gtf -o $output_path/rna_counts_3.txt $bam_lst_3
else
