...
pos_strand_ribocode_extraction['Start'] = pos_strand_ribocode_extraction['Start'].astype(int) - 1 
...
neg_strand_ribocode_extraction['Stop'] = neg_strand_ribocode_extraction['Stop'].astype(int) - 1 
