...
ribocode_positivestrand_transcriptid['Start'] = ribocode_positivestrand_transcriptid['Start'].astype(int) - 1
...
ribocode_negativestrand_transcriptid['Stop'] = ribocode_negativestrand_transcriptid['Stop'].astype(int) - 1
