...
fq_stat_path <- "/home/user/data3/lit/project/sORFs/01-ribo-seq/analysis/Test-20250509/01-output/stat/fq.stat.lst"
output_path <- "/home/user/data3/lit/project/sORFs/01-ribo-seq/analysis/Test-20250509/01-output/stat/"

files <- read.table(fq_stat_path)
