...
# candidateORF.genepred.txt
candidateORF_genepred_path=args[1]
# candidateORF.genepred.callapse.stop_codon.txt
output_path=args[2]
...
fread(candidateORF_genepred_path) -> candidateORF.genepred
...
fwrite(candidateORF.genepred.callapse.stop_codon,
       file = output_path,col.names = F,sep = '\t')