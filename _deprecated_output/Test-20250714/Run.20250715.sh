ls /home/user/data3/lit/project/sORFs/01-ribo-seq/rawdata/organize_all_test_data_20250515/p21_0626*.fq.gz > raw_fastq.lst
script_dir=/home/user/data3/lit/project/sORFs/01-ribo-seq/analysis/Test-20250529
DATE=$(date '+%Y%m%d')
mkdir -p log
bash ./Uni.20250715.sh $PWD/raw_fastq.lst &> log/Run.basic.$DATE.log
