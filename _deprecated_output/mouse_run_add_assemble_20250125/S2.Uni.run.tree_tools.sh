...
# 20250125，改大一点cutoff没有关系，后面都需要做过滤
pvalue_cutoff=1
# 20250125增加对PRICE注释的指定
price_anno_name=mm39_gencvM29_add_s
...
# 先清除文件夹下的文件，再运行
rm -rf ./*
gedi -e Price -reads $PRICE_bam -genomic $price_anno_name -prefix $sample -plot
