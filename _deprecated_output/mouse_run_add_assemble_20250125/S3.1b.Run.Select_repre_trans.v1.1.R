...
# all_orfs_path <- "/home/user/data3/lit/project/sORFs/01-ribo-seq/mouse_brain_output_20241011/Ribo_ORFs_add_assemble_20250125/merge/nonCano.sorf.meta.merge.raw.3_ways.all_samples.txt"
all_orfs_path <- args[1]
# 输出文件夹
output_path <- args[2]
# output_path <- "/home/user/data3/lit/project/sORFs/01-ribo-seq/mouse_brain_output_20241011/Ribo_ORFs_add_assemble_20250125/filter"
...
merge(ORF_id_ENS_id_annotated,trans_mul_feature_add[,c("Transcript_ID","TSL","APPRIS","CDS_l")],by.x = "ENS_id",by.y = "Transcript_ID") -> ORF_id_ENS_id_merge_feature
...
# 20250201 assign新的转录本类型，如果组装后的转录本和注释的转录本编码同一个小肽，那么优先注释的转录本
...
# 5.得到基于转录本去重的所有sORFs
merge(all_orfs,ORF_id_ENS_id_top_trans_1,c("ENS_id","ORF_id_seq")) -> all_orfs_top_trans
