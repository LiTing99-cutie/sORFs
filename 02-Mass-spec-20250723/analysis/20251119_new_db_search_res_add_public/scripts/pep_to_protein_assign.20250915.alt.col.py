...
def main():
    ...
    # print("raw unique (Peptide,Protein_id) =", cand[["Peptide","Protein_id"]].drop_duplicates().shape[0])

    # # 每条肽对应多少不同 Protein
    # vc = cand.groupby("Peptide")["Protein_id"].nunique().value_counts().sort_index()
    # print("n_proteins per peptide (top):")
    # print(vc.head(10))

    # # is_canonical 的分布
    # print("is_canonical value_counts:")
    # print(cand["is_canonical"].value_counts(dropna=False))
