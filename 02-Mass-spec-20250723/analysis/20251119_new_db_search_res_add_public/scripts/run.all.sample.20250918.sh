...
# 需要修改
PEP_ORF_MERGED="../MS_res_from_Galaxy/merge_public_in_house/pep.orf.merged.txt"
INTENSITY_MERGED="../MS_res_from_Galaxy/merge_public_in_house/peptide_intensity_IL.merged.tsv"
file2=../MS_res_from_Galaxy/merge_public_in_house/merged.peptide.tsv                            # 列: Peptide_I_L_equal Source Source_number Sample

RUN_EACH_SAMPLE="./run.all.steps.20250918.v3.sh"   # <- 新版每样本脚本名
SPLIT_BY_SAMPLE="split_by_sample.v2.20251119.py"
