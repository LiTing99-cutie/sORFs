...
adapter=$2
# output dir $3
output_path=./mouse_brain_output

### 参考基因组注释文件，根据物种替换 ###
bowtie2_rRNA_index=/home/user/data3/lit/project/sORFs/01-ribo-seq/ncRNA/merged/hg38.rRNA
bowtie2_tRNA_index=/home/user/data3/lit/project/sORFs/01-ribo-seq/ncRNA/merged/hg38.tRNA
bowtie2_snoRNA_index=/home/user/data3/lit/project/sORFs/01-ribo-seq/ncRNA/merged/hg38.snoRNA
