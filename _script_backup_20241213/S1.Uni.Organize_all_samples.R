...
# res_path <- "/rd1/user/lit/project/sORFs/output/MS/Fragpipe_output/2024_12_13_default_loose_para"
# output_path <- "/rd1/user/lit/project/sORFs/output/MS/stat_2024_12_13_default_loose_para"
# 输出文件夹所在的路径
res_path <- args[1]
output_path <- args[2]
sample_ms2_count_path <- "./output/MS/stat/sample_ms2_count.txt"
